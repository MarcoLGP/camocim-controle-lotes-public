...
import ResumeProductionOrdersModules from "./ResumeProductionOrdersModules";

export default function ProductionOrders({ styles }) {
    ...
    return (
        <div className={styles.production_orders_container}>
            <Row align="center" justify="space-between">
                <Row>
                    <h2 className={styles.production_orders_title}>Pedidos em produção</h2>
                    {search ?
                ...
                <Row onClick={() => push("/dashboard/orders/production_orders")} className={styles.production_orders_view_more_container} align="center">
                    <span>Ver mais</span>
                    <AiOutlineRight size={20} />
                </Row>
            </Row>
            <ResumeProductionOrdersModules />
        </div>
    )
